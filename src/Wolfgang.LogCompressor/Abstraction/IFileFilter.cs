...
internal interface IFileFilter
{
    ...
    /// <param name="olderThanDays">If specified, only files last modified more than this many days ago (before local midnight that many days back) are included.</param>
