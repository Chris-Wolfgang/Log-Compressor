...
param(
    [Parameter()]
    [string]$Repository = "Chris-Wolfgang/Log-Compressor",
...
if ($Repository -eq "Chris-Wolfgang/Log-Compressor" -or -not $Repository) {
    ...
    try {
        ...
        if ($Repository -eq "Chris-Wolfgang/Log-Compressor") {
